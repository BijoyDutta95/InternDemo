 ...
 * Use the {@link fragView#newInstance} factory method to
...
public class fragView extends Fragment {
     ...
     * @return A new instance of fragment fragView.
     */
    // TODO: Rename and change types and number of parameters
    public static fragView newInstance(String param1, String param2) {
        fragView fragment = new fragView();
    ...
    private void getDataResponse() {
        ...
        Call<List<DataModel>> call=requestInteface.getDataJson();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_frag_view, container, false);
